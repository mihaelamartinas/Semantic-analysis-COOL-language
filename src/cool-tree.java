...
class program extends Program {
    ...
    */
	...
	class_ Object_class, Int_class, Bool_class,String_class, IO_class;
	/* some semantic analysis code may go here */
	classTable.verifyStructure();
	...
	/*if there are no errors in the structure of the class we can continue the 
	 * semantic analysis*/
	ArrayList<NodeInhGraph>  inheritanceGraph = classTable.getInheritanceGraphs();
	
	/*Save the objects of the basic COOL classes so that they can be added to the 
	 * inheritance tree
	 * */
	Object_class = classTable.getObject_class();
	Int_class = classTable.getInt_class();
	Bool_class = classTable.getBool_class();
	String_class = classTable.getStr_class();
	IO_class = classTable.getIO_class();
	
	/*
	 * Start semantic analysis
	 * */
	AnalyseTypes  analyseTypes = new AnalyseTypes(inheritanceGraph,classes);
	analyseTypes.assignTypesClasses(Object_class, Int_class, Bool_class,String_class, IO_class);
	
	if (analyseTypes.errors()) {
	    System.err.println("Compilation halted due to static semantic errors.");
	    System.exit(1);
	}
